...
function CrearCarta(){
    ...
    var s=parseInt(document.getElementById("motivo").value);
    if (f===1){
       genero='Mujer';
    }
    if (f===2){
    ...
    if (s===1){
        motivo='Me interesa el área de interés';
     }
     if (s===2){
        motivo='Me interesa tener experiencia fuera de mi región';
     }
     if (s==3){
        motivo='Otro Motivo de interés';
     }
